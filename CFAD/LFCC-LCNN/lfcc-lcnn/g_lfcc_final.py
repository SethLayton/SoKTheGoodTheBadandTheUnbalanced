...
def extract_feat(l_utt):
    ...
    for line in tqdm(l_utt):
        ...
        if os.path.exists(_dir_dataset +_dir_name + fn):
            continue
        # print(line)
        # utt, _ = librosa.load(path=line)
        utt, _ = sf.read(line)
        ####normalize
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_dataset', type=str, default='')
    args = parser.parse_args()
    _dir_dataset = args.dir_dataset
    l_utt = []

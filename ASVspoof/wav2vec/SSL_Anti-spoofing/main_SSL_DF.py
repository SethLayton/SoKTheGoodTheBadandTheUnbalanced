...
if __name__ == '__main__':
    ...
    parser.add_argument('--iteration_number', type=str, default=None)
    # Dataset
    ...
    args.protocol_path = os.path.join(args.protocol_path, f"{args.iteration_number}.txt")
    ...
    train_loader = DataLoader(train_set, batch_size=args.batch_size,num_workers=3, shuffle=True,drop_last = True)
    ...
    torch.save(model.state_dict(), os.path.join(
        model_save_path, '{}.pth'.format(args.iteration_number)))

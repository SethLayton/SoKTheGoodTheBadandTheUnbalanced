...
def protocol_parse(protocol_filepath):
    ...
    """ 
    if len(protocol_filepath) == 1:
        protocol_filepath = protocol_filepath[0]
    data_buffer = {}
    try:
...
class Model(torch_nn.Module):
    ...
    def __init__(self, in_dim, out_dim, args, prj_conf, mean_std=None):
        ...
        protocol_file = (prj_conf.optional_argument)[0].format(args.iteration_numbers)
        print(protocol_file)
    ...
    def forward(self, x, fileinfo, f=None):
        ...
        if self.training:
            ...
            out = "Output, %s, %s, %f\n" % (filenames[0],target[0] or "", scores.mean())
            f.write(out)

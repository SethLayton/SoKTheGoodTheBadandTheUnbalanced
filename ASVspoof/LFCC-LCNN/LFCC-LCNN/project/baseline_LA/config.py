...
trn_set_name = 'asvspoof2021_trn_librispeech-{}'

trn_list = '../../ASVspoofTrain/lsts/{}.lst'  
...
input_dirs = ['../../../../DataSets/ASVspoof/ASVspoofAndLibriSpeech/']
...
#  we read target labels of ASVspoof trials in model.py
...
optional_argument = ['../../ASVspoofTrain/protocols/{}.txt']
#########################################################
## Configuration for inference stage
#########################################################
# similar options to training stage

test_set_name = 'asvspoof2021_eval'
test_set_name_ro = 'real-only_eval'

# List of test set data
# for convenience, you may directly load test_set list here
test_list = '../../ASVspoofEval/lsts/asv21_eval.lst'
test_list_ro = '../../RealOnlyEval/lsts/ro_eval.lst'

# Directories for input features
# input_dirs = [path_of_feature_1, path_of_feature_2, ..., ]
# directory of the evaluation set waveform
test_input_dirs = ['../../../../DataSets/ASVspoof/Eval/ASVspoof2021_DF_eval/flac']
test_input_dirs_ro = ['../../../../DataSets/RealOnlyEval/real/']

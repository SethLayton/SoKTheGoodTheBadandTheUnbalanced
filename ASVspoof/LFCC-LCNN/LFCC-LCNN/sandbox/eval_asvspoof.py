...
import sys
import numpy as np
sys.path.insert(0,'/orange/vbindschaedler/sethlayton/orange_storage/LFCCLCNN')
...
def tDCF_wrapper(bonafide_cm_scores, spoof_cm_scores, 
                 ...
                 flag_verbose=False, flag_legacy=False):
    """ 
    ...
    return None, eer_cm, eer_threshold
...
def ASVspoof2019_evaluate(bonafide_cm_scores, bonafide_cm_file_names,
    ...
    # file_name = "/orange/vbindschaedler/sethlayton/orange_storage/DataSets/ASVspoof/ASVspoofEval/protocols/10fake_90real_iter0.txt"

    # protocol_data = np.genfromtxt(file_name, 
    #                               dtype=[('file', 'U20'),('type','U10')], delimiter=" ")
    # spoof_type_dic = {protocol_data[x][0]:protocol_data[x][1] for x in \
    #                   range(protocol_data.shape[0])}

    # spoof_attack_types = list(set([x[1] for x in protocol_data]))
...
if __name__ == "__main__":
    ...
    path = "/orange/vbindschaedler/sethlayton/orange_storage/LFCCLCNN/results/train-10fake90real_iter0___eval-10fake_90real_iter0.scores"
    # parse_pytorch_output_txt("/orange/vbindschaedler/sethlayton/orange_storage/LFCCLCNN/results/train-10fake90real_iter0___eval-10fake_90real_iter0.scores")

    res = ASVspoof2019_decomposed_results(path,True,True)
    print(res)
